...
class pulsedJammer(gr.top_block):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_complex_to_interleaved_char_0, 0))
    ...
    def set_prf(self, prf):
        self.prf = prf
        self.analog_sig_source_x_1.set_frequency(self.prf)
...
def main(top_block_cls=pulsedJammer, options=None):
    tb = top_block_cls()
