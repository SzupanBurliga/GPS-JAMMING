...
class rtl_sdr_gps_sampler(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "RTL-SDR GPS sampler", catch_exceptions=True)
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, 1.0, 1.0)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, (1/sweep_time), 500000, 0, 0)
        ...
        self.connect((self.blocks_vco_c_0, 0), (self.blocks_complex_to_interleaved_char_0, 0))
    ...
    def set_sweep_time(self, sweep_time):
        ...
        self.analog_sig_source_x_0.set_frequency((1/self.sweep_time))
...
def main(top_block_cls=rtl_sdr_gps_sampler, options=None):
    tb = top_block_cls()
